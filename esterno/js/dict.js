...
document.addEventListener('DOMContentLoaded', function() {
    const openDictBtn = document.getElementById('openDict');
    
    if (!openDictBtn) {
        console.error('Bottone dizionario non trovato!');
        return;
    }

    openDictBtn.addEventListener('click', function(e) {
        e.preventDefault();
        openDictionaryModal();
    });
    ...
    function openDictionaryModal() {
        // Previeni duplicati
        if (document.getElementById('dict-modal')) {
            return;
        }
        ...
        modal.innerHTML = `
            ...
            ">
                ...
                <h3 style="color: var(--gold); margin-bottom: 1.5rem; font-family: 'Cinzel', serif;">
                    📘 Dizionario Filosofico
                </h3>
                
                <!-- Barra di ricerca -->
                <div style="margin-bottom: 1.5rem;">
                    <input type="text" id="dict-search-input" placeholder="Cerca termine filosofico..." style="
                        width: 100%;
                        padding: 0.75rem;
                ...
                <div style="margin-top: 1.5rem; display: flex; gap: 1rem; justify-content: flex-end;">
                    <button id="dict-search-btn" style="
                    ...
                    <button id="dict-close-btn" style="
                        padding: 0.75rem 1.5rem;
        ...
        function performSearch() {
            ...
            sources.forEach((source, index) => {
                const url = source.dataset.url.replace('{q}', encoded);
                setTimeout(() => {
                    window.open(url, '_blank');
                }, index * 100);
            });
        ...
        closeDictBtn.addEventListener('click', closeModal);
