...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* === POINTER === */
  btn.addEventListener("pointerenter", openOverlay);
  btn.addEventListener("pointerleave", closeOverlay);

  overlay.addEventListener("pointerenter", () => clearTimeout(hideTimeout));
  overlay.addEventListener("pointerleave", closeOverlay);

  /* === TASTIERA === */
  btn.addEventListener("focus", openOverlay);
  btn.addEventListener("blur", closeOverlay);

  overlay.addEventListener("focusin", openOverlay);
  overlay.addEventListener("focusout", closeOverlay);
